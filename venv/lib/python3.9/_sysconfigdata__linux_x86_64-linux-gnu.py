...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/workspaces/allora-mdk/venv/bin',
 'BINLIBDEST': '/workspaces/allora-mdk/venv/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': 'gcc -pthread -B /workspaces/allora-mdk/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,--allow-shlib-undefined '
              '-Wl,-rpath,/workspaces/allora-mdk/venv/lib '
              '-Wl,-rpath-link,/workspaces/allora-mdk/venv/lib '
              '-L/workspaces/allora-mdk/venv/lib '
              ''
              ''
              '-Wl,--allow-shlib-undefined '
              '-Wl,-rpath,/workspaces/allora-mdk/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /workspaces/allora-mdk/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O2 -Wall '
           '-fPIC '
           '-O2   '
           '-isystem '
           '/workspaces/allora-mdk/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/workspaces/allora-mdk/venv/include '
                       '-I/workspaces/allora-mdk/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,--allow-shlib-undefined '
                      '-Wl,-rpath,/workspaces/allora-mdk/venv/lib '
 ...
 'CONFIGURE_LDFLAGS_NODIST': ''
                             '-g',
 'CONFIG_ARGS': "'--prefix=/workspaces/allora-mdk/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/workspaces/allora-mdk/venv/share/zoneinfo:/workspaces/allora-mdk/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/workspaces/allora-mdk/venv/include'"
                "'--with-tcltk-libs=-L/workspaces/allora-mdk/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/workspaces/allora-mdk/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/workspaces/allora-mdk/venv/include',
 'CONFINCLUDEPY': '/workspaces/allora-mdk/venv/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/workspaces/allora-mdk/venv/include '
             '-I/workspaces/allora-mdk/venv/include',
 'CXX': 'g++ -pthread -B /workspaces/allora-mdk/venv/compiler_compat',
 'DESTDIRS': '/workspaces/allora-mdk/venv '
             '/workspaces/allora-mdk/venv/lib '
             '/workspaces/allora-mdk/venv/lib/python3.9 '
             '/workspaces/allora-mdk/venv/lib/python3.9/lib-dynload',
 'DESTLIB': '/workspaces/allora-mdk/venv/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/workspaces/allora-mdk/venv/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/workspaces/allora-mdk/venv/include '
                   '/workspaces/allora-mdk/venv/include '
                   '/workspaces/allora-mdk/venv/include/python3.9 '
                   '/workspaces/allora-mdk/venv/include/python3.9',
 'INCLUDEDIR': '/workspaces/allora-mdk/venv/include',
 'INCLUDEPY': '/workspaces/allora-mdk/venv/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /workspaces/allora-mdk/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,--allow-shlib-undefined '
            '-Wl,-rpath,/workspaces/allora-mdk/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /workspaces/allora-mdk/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,--allow-shlib-undefined '
             '-Wl,-rpath,/workspaces/allora-mdk/venv/lib '
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/workspaces/allora-mdk/venv/lib/python3.9',
 'LIBDIR': '/workspaces/allora-mdk/venv/lib',
 'LIBFFI_INCLUDEDIR': '/workspaces/allora-mdk/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/allora-mdk/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/allora-mdk/venv/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LINKCC': 'gcc -pthread -B /workspaces/allora-mdk/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/workspaces/allora-mdk/venv/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /workspaces/allora-mdk/venv/compiler_compat',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/home/conda/feedstock_root/build_artifacts/python-split_1727717763064/work/Modules/makesetup',
 'MANDIR': '/workspaces/allora-mdk/venv/share/man',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/workspaces/allora-mdk/venv/include',
 'OPENSSL_LDFLAGS': '-L/workspaces/allora-mdk/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/workspaces/allora-mdk/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/workspaces/allora-mdk/venv/include',
 'TCLTK_LIBS': '-L/workspaces/allora-mdk/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/workspaces/allora-mdk/venv/share/zoneinfo:/workspaces/allora-mdk/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3 '
 ...
 'datarootdir': '/workspaces/allora-mdk/venv/share',
 'exec_prefix': '/workspaces/allora-mdk/venv',
 'prefix': '/workspaces/allora-mdk/venv',
